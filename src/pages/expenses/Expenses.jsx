...
export default function Expenses() {
  ...
  const openEdit   = (e) => { setSelected(e); setForm({ ...e, date: e.date?.split('T')[0] }); setModalOpen(true); };
